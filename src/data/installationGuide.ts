...
export const wiringConnections = [
  ...
  { component: 'TFT ILI9341', pin: 'VCC / LED', esp32Pin: 'VCC=5V, LED=3.3V', color: 'bg-red-500', note: 'ছবির লাল ৯-পিন রেগুলেটরযুক্ত মডিউল; VCC ও LED এক করবেন না' },
...
✅ ভালভ না খুললে পাম্প চলবে না (ড্রাই রান প্রোটেকশন)`,
  ...
  // ─────── v8.3.0 প্যানেল ডিসপ্লে ও ইন্ডিকেটর LED ───────
  {
    ...
    pins: [
      { sensorPin: 'VCC', esp32Pin: 'VIN / 5V', wireColor: 'লাল', wireNameEn: 'RED', instruction: '🔴 ছবির লাল ৯-পিন ILI9341 মডিউলের VCC → ESP32 VIN/5V', warning: '⚠️ এটি অনবোর্ড 3.3V রেগুলেটরযুক্ত লাল মডিউলের জন্য। রেগুলেটরবিহীন bare panel হলে 3.3V ছাড়া দেবেন না।' },
      ...
      { sensorPin: 'LED (ব্যাকলাইট)', esp32Pin: '3.3V', wireColor: 'গোলাপি', wireNameEn: 'PINK', instruction: '🩷 LED পিন → ESP32 3.3V (শুধু ব্যাকলাইট)', warning: 'VCC ও LED পিন এক করবেন না: VCC=5V, LED=3.3V।' },
      { sensorPin: 'MISO (SDO)', esp32Pin: 'GPIO 39 (VN)', wireColor: 'বেগুনি', wireNameEn: 'PURPLE', instruction: '🟣 SDO(MISO) → ESP32 GPIO 39 (VN) — ডিসপ্লে সত্যিই সাড়া দিচ্ছে কিনা বুট-চেকে দেখানোর জন্য', warning: '⬜ ঐচ্ছিক: না লাগালেও ডিসপ্লে চলবে, তবে সিরিয়াল মনিটরে “panel did not answer” বার্তা আসবে — উপেক্ষা করুন।' },
      { sensorPin: 'T_CLK / T_CS / T_DIN / T_DO / T_IRQ (টাচ)', esp32Pin: '— (খালি)', wireColor: '—', wireNameEn: 'NONE', instruction: '⬜ টাচ প্যানেলের ৫টি পিন খালি রাখুন — v8-এ টাচ ব্যবহার হয় না', warning: null },
    ],
    extraNote: '🖥️ v8.3.0 ফার্মওয়্যারে `displayManagerTick()` নন-ব্লকিংভাবে প্রতি ২ সেকেন্ডে স্ক্রিন আপডেট করে — তাপমাত্রা, আর্দ্রতা, অ্যামোনিয়া, ৮টি রিলের অবস্থা, WiFi/GSM সিগন্যাল ও সেফটি স্ট্যাটাস দেখায়। \n\n✅ **ঐচ্ছিক:** ডিসপ্লে এখন না লাগালেও কোনো সমস্যা নেই। ফার্মওয়্যার জেনারেটরে “বোর্ডে TFT ডিসপ্লে আছে” সুইচটি বন্ধ রাখুন (ডিফল্ট) — তখন `DISPLAY_ENABLED false` থাকে, Adafruit GFX/ILI9341 লাইব্রেরি লাগে না এবং রিলে/সেফটি লজিক হুবহু একই থাকে। পরে ডিসপ্লে বসিয়ে সুইচ চালু করে আবার ফার্মওয়্যার জেনারেট ও ফ্ল্যাশ করলেই হবে।\n\n🟥 **স্ক্রিন সাদা / কিছুই দেখায় না? ধাপে ধাপে:**\n১. ফার্মওয়্যার জেনারেটরে “বোর্ডে TFT ডিসপ্লে আছে” সুইচ **চালু** করে নতুন করে ডাউনলোড করুন — বন্ধ থাকলে ডিসপ্লে কোড কম্পাইলই হয় না, প্যানেল শুধু ব্যাকলাইটে সাদা থাকে।\n২. Arduino IDE-তে “Adafruit GFX Library” ও “Adafruit ILI9341” ইনস্টল করে আপলোড করুন।\n৩. ছবির লাল ৯-পিন, অনবোর্ড রেগুলেটরযুক্ত মডিউলে **VCC=VIN/5V** এবং **LED=3.3V** দিন—দুটি পিন এক করবেন না। শুধু VCC-তে 3.3V দিলে রেগুলেটরের পরে ভোল্টেজ কমে সাদা থাকতে পারে।\n৪. চালু হলে প্রথমে **লাল → সবুজ → নীল** ফ্ল্যাশ, তারপর ওয়েলকাম স্ক্রিন আসবে।\n৫. ফ্ল্যাশ না দেখলে মিলিয়ে দেখুন: **CS=GPIO17, DC=GPIO5, SCK=GPIO21, MOSI=GPIO22, VCC=5V, LED=3.3V, GND=GND, RST→ESP32 EN**।\n৬. **RESET পিন ফ্লোটিং রাখবেন না** — RESET অবশ্যই ESP32 EN বা 10kΩ দিয়ে 3.3V-তে যাবে।\n৭. জাম্পার তার ২০ সেমির কম রাখুন; নতুন ফার্মওয়্যার নির্দিষ্ট পিনে নির্ভরযোগ্য SPI ব্যবহার করে।\n৮. SDO(MISO) → GPIO 39 লাগিয়ে রিবুট করুন: সিরিয়ালে `DIAG=0xC0` এলে প্যানেল জীবিত, `DIAG=0x00/0xFF` এলে তার/পাওয়ার সমস্যা।\n৯. সিরিয়াল মনিটর (115200) খুলে `Display: ENABLED` ও `TFT self-test done (explicit-pin SPI)` লাইন দুটি খুঁজুন।',
    resistorNote: '📍 SPI গতি ৮ MHz; তার ২০ সেন্টিমিটারের বেশি লম্বা হলে SCK ও MOSI লাইনে ৩৩Ω সিরিজ রেজিস্টর দিন — নয়েজ কমবে।',
    tips: [
      ...
      '🚦 বুটে লাল → সবুজ → নীল ফ্ল্যাশ = তার ও SPI ঠিক আছে; ফ্ল্যাশ না হলে আগে তার চেক করুন',
      '⚡ ছবির লাল রেগুলেটরযুক্ত মডিউল: VCC=5V, LED=3.3V; bare panel-এর নিয়ম আলাদা',
    ],
