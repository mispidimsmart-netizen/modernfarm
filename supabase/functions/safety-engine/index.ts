  ...
  try {
    ...
    if (action === "evaluate") {
      ...
      await supabase.from("safety_timeline").insert({
        ...
        requested_ceiling_fan: input.ceiling_fan_on || false,
        requested_sprinkler: input.sprinkler_on || false,
        ...
        actual_ceiling_fan: input.ceiling_fan_on || false,
        actual_sprinkler: input.sprinkler_on || false,
    ...
    if (action === "forensic_log") {
      ...
      const { error } = await supabase.from("safety_timeline").insert({
        ...
        requested_ceiling_fan: entry.requested_ceiling_fan ?? false,
        requested_sprinkler: entry.requested_sprinkler ?? false,
        ...
        actual_ceiling_fan: entry.actual_ceiling_fan ?? false,
        actual_sprinkler: entry.actual_sprinkler ?? false,
