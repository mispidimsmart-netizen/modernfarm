      ...
      <div className="mx-auto max-w-2xl space-y-3">
        ...
        <div ref={sheetRef} className="overflow-hidden rounded-2xl border border-primary/20 bg-background shadow-lg">
          ...
          <div className="p-5">
            ...
            <section className="mt-4 rounded-xl border border-primary/20 bg-muted/40 px-3 py-2 sm:px-4 sm:py-3">
              {/* Top: project logo + name */}
              <div className="flex flex-col items-center gap-1 border-b border-primary/15 pb-2 text-center">
                <img src={smartLogo.url} alt="SMART Project লোগো" className="h-8 w-auto max-w-[60%] object-contain sm:h-10" crossOrigin="anonymous" />
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 sm:gap-4">
                <div className="flex min-w-0 flex-col items-center text-center">
                  <div className="flex h-7 items-center justify-center sm:h-9">
                    <img src={pksfLogo.url} alt="পিকেএসএফ লোগো" className="max-h-full max-w-full object-contain" crossOrigin="anonymous" />
                  </div>
                  <p className="mt-0.5 text-[9px] leading-tight text-muted-foreground">সহযোগীতায়</p>
                  <p className="text-[10px] font-semibold leading-tight text-foreground">পিকেএসএফ</p>
                </div>
                <div className="flex min-w-0 flex-col items-center text-center">
                  <div className="flex h-7 items-center justify-center sm:h-9">
                    <img src={pidimLogo.url} alt="পিদিম ফাউন্ডেশন লোগো" className="max-h-full max-w-full object-contain" crossOrigin="anonymous" />
                  </div>
                  <p className="mt-0.5 text-[9px] leading-tight text-muted-foreground">বাস্তবায়নে</p>
                  <p className="text-[10px] font-semibold leading-tight text-foreground">পিদিম ফাউন্ডেশন</p>
                </div>
              </div>
            </section>
