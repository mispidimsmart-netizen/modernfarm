...
const detailedWiringGuide = [
 ...
 └────────────┘        │
  ...
  },
  {
    ...
    pins: [],
    extraNote: '🔄 একটি মাত্র পাম্প দিয়ে ফগার ও স্প্রিংকলার দুটোই চালানো যায়!\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n🔌 রিলে কানেকশন ডায়াগ্রাম:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n📍 DC সোলেনয়েড ভালভ #1 (ফগার) → রিলে IN5 (GPIO 12):\n┌─────────────────────────────────────────────┐\n│  12V DC (+) ──→ রিলে IN5 এর COM টার্মিনাল   │\n│  রিলে IN5 এর NO ──→ সোলেনয়েড ভালভ (+) তার  │\n│  সোলেনয়েড ভালভ (-) তার ──→ 12V DC GND (-)  │\n└─────────────────────────────────────────────┘\n\n📍 DC সোলেনয়েড ভালভ #2 (স্প্রিংকলার) → রিলে IN7 (GPIO 15):\n┌─────────────────────────────────────────────┐\n│  12V DC (+) ──→ রিলে IN7 এর COM টার্মিনাল   │\n│  রিলে IN7 এর NO ──→ সোলেনয়েড ভালভ (+) তার  │\n│  সোলেনয়েড ভালভ (-) তার ──→ 12V DC GND (-)  │\n└─────────────────────────────────────────────┘\n\n⚡ পাম্প কানেকশন (দুটি অপশন):\n\n🅰️ DC পাম্প (12V, ≤0.5HP) — কন্ট্যাক্টর লাগবে না:\n┌─────────────────────────────────────────────┐\n│  12V DC (+) ──→ পাম্প (+) তার               │\n│  পাম্প (-) তার ──→ 12V DC GND (-)          │\n│  ⚙️ পাম্প সবসময় চালু থাকে                    │\n│  ভালভ খুললেই পানি যায় — ভালভ বন্ধ = পানি বন্ধ │\n└─────────────────────────────────────────────┘\n\n🅱️ AC বুস্টার পাম্প (220V, >0.5HP) — কন্ট্যাক্টর লাগবে:\n┌─────────────────────────────────────────────┐\n│  ⚠️ এই অপশনে ইলেকট্রিশিয়ান দিয়ে করান!     │\n│  MCB 1P 16A ──→ কন্ট্যাক্টর A1 টার্মিনাল    │\n│  কন্ট্যাক্টর A2 ──→ নিউট্রাল                  │\n│  কন্ট্যাক্টর কয়েল ──→ রিলে (আলাদা চ্যানেল)   │\n│  কন্ট্যাক্টর পাওয়ার আউট ──→ পাম্প             │\n└─────────────────────────────────────────────┘\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n📐 সম্পূর্ণ প্লাম্বিং ডায়াগ্রাম:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nট্যাঙ্ক → পাম্প → T-জয়েন্ট ──┬── DC ভালভ (IN5) → ফগার নজল\n                              └── DC ভালভ (IN7) → স্প্রিংকলার হেড\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n🛡️ সেফটি সিকোয়েন্স (ফার্মওয়্যার অটো):\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nচালু: ভালভ ON → ২সে অপেক্ষা → পাম্প ON\nবন্ধ: পাম্প OFF → ২সে অপেক্ষা → ভালভ OFF\n⛔ ভালভ বন্ধ থাকলে পাম্প চলবে না (ড্রাই রান প্রোটেকশন)\n⛔ ফগার + স্প্রিংকলার একসাথে চলবে না\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n🛒 প্রয়োজনীয় যন্ত্রাংশ:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n• DC 12V সোলেনয়েড ভালভ ½\" (2টি) — ৳200-300/টি\n• T-জয়েন্ট ½\" (1টি) — ৳30-50\n• DC 12V ডায়াফ্রাম পাম্প 100PSI (1টি) — ৳800-1500\n• ½\" পাইপ ও ফিটিংস — ৳200-500\n• ফ্রি-হুইলিং ডায়োড 1N4007 (2টি) — ভালভে লাগানো বাধ্যতামূলক!\n\n💡 সুবিধা:\n✅ কন্ট্যাক্টর লাগে না — সরাসরি রিলে থেকে চালানো যায়\n✅ খরচ কম — মোট ৳1,500-2,500\n✅ সেটআপ সহজ — নিজেই করা যায়',
    resistorNote: null,
    tips: [
