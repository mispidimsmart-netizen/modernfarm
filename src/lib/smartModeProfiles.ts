/**
 * Smart Mode Profiles — PURE CONFIG (Single Source of Truth)
 *
 * Preset farm_settings bundles applied when a smart mode is selected
 * (manually or by weather auto-mode). No React / no network here.
 */
