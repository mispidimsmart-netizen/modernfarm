...
✅ ভালভ না খুললে পাম্প চলবে না (ড্রাই রান প্রোটেকশন)`,
  ...
  },
  {
    ...
    pins: [
      ...
      { sensorPin: 'TX (সেন্সর আউটপুট)', esp32Pin: 'GPIO 13 (RX1)', wireColor: 'সবুজ', wireNameEn: 'GREEN', instruction: '🟢 PMS5003 TX → ESP32 GPIO 13 (UART1 RX)', warning: '⚠️ GPIO 13 যদি Alarm relay-তে ব্যবহৃত থাকে (legacy v8 mapping), তাহলে PMS5003 add করার আগে relay map v10-এ migrate করুন।' },
...
const wiringCategories = [
  ...
  { id: 'light', name: '💡 আলো / Lux (BH1750)', nameEn: 'Light / Lux', icon: Lightbulb, color: 'text-amber-500', bgColor: 'bg-amber-500/10', sensorIds: ['bh1750'] },
