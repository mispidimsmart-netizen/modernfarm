 ...
 * ║                                                                        ║
 * ║  ORIGINAL: esp32-failsafe.ino (Big Farm Fail-Safe Controller)         ║
...
void setup() {
  ...
  Serial.println("║  SOURCE: esp32-failsafe.ino                                ║");
...
void loop() {
  Serial.println("[LEGACY_DISABLED] esp32-failsafe.ino – No hardware authority. Upload esp32-industrial.ino.");
  delay(30000);
}
