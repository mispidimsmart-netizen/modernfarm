...
import { Mail, Lock, Phone, User, Building2, Crown, HardHat, Ticket, Egg, Eye, EyeOff, ChevronDown } from 'lucide-react';
    ...
    <div className={`relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/85 px-6 text-center ${isSignUp ? 'pb-8 pt-10' : 'pb-10 pt-14'}`}>
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10">
        <motion.div
          ...
          className={`mx-auto mb-3 flex items-center justify-center rounded-3xl bg-white shadow-xl ${isSignUp ? 'h-20 w-20' : 'h-28 w-28'}`}
        >
          <img src={farmeyeLogo} alt="FarmEye" className={`object-contain ${isSignUp ? 'h-14 w-14' : 'h-20 w-20'}`} />
        </motion.div>
