...
export function LoginPage() {
  ...
  // ─── Compact Header ───
  const Header = () => (
    <div className={`shrink-0 overflow-hidden rounded-2xl sm:rounded-[2rem] mx-2 mt-2 sm:mx-3 sm:mt-3 bg-gradient-to-br from-primary/90 via-primary to-primary/80 dark:from-primary/70 dark:via-primary/85 dark:to-primary/60 px-6 text-center shadow-lg shadow-primary/20 ${isSignUp ? 'pb-10 pt-5 sm:pb-14 sm:pt-8' : 'pb-12 pt-6 sm:pb-16 sm:pt-10'}`}>
