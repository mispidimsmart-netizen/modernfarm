 ...
 * ║                                                                        ║
 * ║  ORIGINAL: esp32-unified.ino (Industrial Safety Model v6.0)           ║
...
void setup() {
  ...
  Serial.println("║  SOURCE: esp32-unified.ino                                  ║");
...
void loop() {
  Serial.println("[LEGACY_DISABLED] esp32-unified.ino – No hardware authority. Upload esp32-industrial.ino.");
  delay(30000);
}
