  ...
  },
  {
    ...
    buzzerWiringInfo: {
      ...
      components: [
        ...
        { name: 'রিলে মডিউল', spec: 'চ্যানেল IN3 (GPIO 33 দ্বারা নিয়ন্ত্রিত)' }
      ],
      connectionSteps: [
        { step: 1, title: 'রিলে IN3 ইনপুট সংযোগ', desc: 'ESP32 GPIO 33 → রিলে IN3 পিন (এটা ইতিমধ্যে রিলে সেকশনে করা হয়েছে)', color: 'purple' },
        { step: 2, title: 'পাওয়ার সোর্স + কানেকশন', desc: '12V/24V পাওয়ার সাপ্লাই এর + (পজিটিভ) → রিলে IN3 এর NO (Normally Open) টার্মিনাল', color: 'red' },
        { step: 3, title: 'বাজার + কানেকশন', desc: 'SFM-27 বাজারের + (লাল তার) → রিলে IN3 এর COM (Common) টার্মিনাল', color: 'red' },
        { step: 4, title: 'GND কানেকশন', desc: 'SFM-27 বাজারের - (কালো তার) → পাওয়ার সাপ্লাই এর - (GND)', color: 'black' }
      ],
      workingLogic: {
        title: 'কিভাবে কাজ করে?',
        offState: {
          title: 'রিলে OFF (GPIO 33 = HIGH)',
          desc: 'NO ও COM আলাদা থাকে → সার্কিট ওপেন → বাজার বন্ধ'
        },
        onState: {
          title: 'রিলে ON (GPIO 33 = LOW)',
