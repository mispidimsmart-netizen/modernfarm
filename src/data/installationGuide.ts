...
✅ ভালভ না খুললে পাম্প চলবে না (ড্রাই রান প্রোটেকশন)`,
  ...
  // ─────── v8.3.0 প্যানেল ডিসপ্লে ও ইন্ডিকেটর LED ───────
  {
    ...
    extraNote: '🖥️ v8.3.0 ফার্মওয়্যারে `displayManagerTick()` নন-ব্লকিংভাবে প্রতি ২ সেকেন্ডে স্ক্রিন আপডেট করে — তাপমাত্রা, আর্দ্রতা, অ্যামোনিয়া, ৮টি রিলের অবস্থা, WiFi/GSM সিগন্যাল ও সেফটি স্ট্যাটাস দেখায়। \n\n✅ **ঐচ্ছিক:** ডিসপ্লে এখন না লাগালেও কোনো সমস্যা নেই। ফার্মওয়্যার জেনারেটরে “বোর্ডে TFT ডিসপ্লে আছে” সুইচটি বন্ধ রাখুন (ডিফল্ট) — তখন `DISPLAY_ENABLED false` থাকে, Adafruit GFX/ILI9341 লাইব্রেরি লাগে না এবং রিলে/সেফটি লজিক হুবহু একই থাকে। পরে ডিসপ্লে বসিয়ে সুইচ চালু করে আবার ফার্মওয়্যার জেনারেট ও ফ্ল্যাশ করলেই হবে।\n\n🟥 **স্ক্রিন সাদা / কিছুই দেখায় না? ধাপে ধাপে:**\n১. ফার্মওয়্যার জেনারেটরে “বোর্ডে TFT ডিসপ্লে আছে” সুইচ **চালু** করে নতুন করে ডাউনলোড করুন — বন্ধ থাকলে ডিসপ্লে কোড কম্পাইলই হয় না, প্যানেল শুধু ব্যাকলাইটে সাদা থাকে (সবচেয়ে সাধারণ কারণ)।\n২. Arduino IDE-তে “Adafruit GFX Library” ও “Adafruit ILI9341” ইনস্টল করে আপলোড করুন।\n৩. চালু হলে স্ক্রিনে প্রথমে **লাল → সবুজ → নীল** ফ্ল্যাশ (সেল্ফ-টেস্ট), তারপর ওয়েলকাম স্ক্রিন আসবে।\n৪. ফ্ল্যাশ না দেখলে সমস্যা তারে — মিলিয়ে দেখুন: **CS=GPIO17, DC=GPIO5, SCK=GPIO21, MOSI=GPIO22, VCC=3.3V, LED=3.3V, GND=GND, RST→ESP32 EN**।\n৫. **RESET পিন ফ্লোটিং রাখবেন না** — লাল 2.4″ মডিউলে RESET অবশ্যই ESP32 EN বা 10kΩ দিয়ে 3.3V-তে যেতে হবে; খালি থাকলে প্যানেল সাদা থাকে।\n৬. তারপরও সাদা থাকলে জাম্পার তার ছোট করুন (<২০ সেমি) এবং SCK/MOSI-তে ৩৩Ω সিরিজ রেজিস্টর দিন — SPI গতি এখন ৮ MHz করা আছে।\n৭. SDO(MISO) → GPIO 39 লাগিয়ে রিবুট করুন: সিরিয়ালে `DIAG=0xC0` এলে প্যানেল জীবিত (সমস্যা কোডে), `DIAG=0x00/0xFF` এলে সমস্যা তার/পাওয়ারে।\n৮. মডিউলের চিপ ILI9341 কিনা নিশ্চিত হোন — ST7789/ILI9488 হলে এই লাইব্রেরিতে সাদা থাকবে।\n৯. সিরিয়াল মনিটর (115200) খুলে `Display: ENABLED` ও `TFT self-test done` লাইন দুটি খুঁজুন।',
    ...
    tips: [
      ...
      '⚡ VCC ও LED দুটোই 3.3V — 5V দিলে মডিউল নষ্ট হবে',
    ],
